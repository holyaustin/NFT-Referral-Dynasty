...
export function ReferralStats({ address, isPublic = false, events: propEvents }: ReferralStatsProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-2xl font-bold gradient-text">{totalRewards}</p>
          <p className="text-xs text-gray-500">STT Earned</p>
        </div>
        <div className="text-center">
          <ArrowTrendingUpIcon className="h-6 w-6 mx-auto text-purple-500 mb-2" />
          <p className="text-2xl font-bold gradient-text">{displayEvents.length}</p>
